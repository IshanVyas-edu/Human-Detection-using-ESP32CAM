const char* ssid     = "SETUP-EC4C";   
const char* password = "copied7781court"; 
...
// control ends
 ...
 WiFi.config(IPAddress(192, 168, 0, 15), IPAddress(192, 168, 43, 2), IPAddress(255, 255, 255, 0));
...
static const char PROGMEM INDEX_HTML[] = R"rawliteral(
  ...
  <body style = "display:flex; justify-content:center; background-color:#6BB9B2">
    ...
    function DetectImage() {
      Model.detect(canvas).then(Predictions => {    
        ...
        if (Predictions.length>0) {
          ...
          result.innerHTML = "Unrecognizable...Please wait";
          count.innerHTML = "0";
        }
